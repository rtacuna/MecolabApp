...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    // MARK: Helpers
    func createNewNewsItem(notificationDictionary:[String: AnyObject], number: String) -> Messages? {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "reneACuna.Mecolab1" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Mecolab1", withExtension: "momd")!
